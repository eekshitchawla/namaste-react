...
import pic from "../assets/shopping-cart.png";
...
const Header = () => {
  ...
  return (
    <div className="sticky flex items-center justify-around flex-wrap shadow-lg">
      {/* Swiggy Logo */}
      <Link to="/">
        <div className="logo-container flex justify-center items-center">
          <svg
            className="logo _8pSp-"
            viewBox="0 0 559 825"
            height="49"
            width="34"
            fill="#fc8019"
